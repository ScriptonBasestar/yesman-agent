...
from libs.core.error_handling import YesmanError, ErrorCategory
from libs.workflows.models import WorkflowExecution, WorkflowConfig, WorkflowStatus
...
class WorkflowService:
    ...
    def __init__(self, execution_engine: AsyncWorkflowExecutionEngine, template_manager: Optional[WorkflowTemplateManager] = None):
    ...
    def get_template_config(self, template_id: str) -> Optional[WorkflowConfig]:
    ...
    async def start_workflow(self, template_id: str, context: Optional[Dict[str, Any]] = None) -> str:
    ...
    def list_executions(self, status_filter: Optional[WorkflowStatus] = None) -> List[WorkflowExecution]:
