...
from libs.workflows.models import WorkflowStatus, WorkflowExecution
...
def run(template_id: str, project_path: Optional[str], var: tuple, detached: bool, monitor: bool) -> None:
    """Run a workflow template."""
    # Parse variables
    variables = {}
    for v in var:
...
def status(execution_id: Optional[str], list_all: bool, running: bool) -> None:
    """Check workflow execution status."""
